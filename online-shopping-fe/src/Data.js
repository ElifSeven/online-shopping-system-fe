...
/**Products.map(product =>
 ...
 <div>
 {product.imageUrls.map(imageUrl => <img src = {imageUrl}/>)}
...
const sampleProducts = [
...

  {
    ...
    category: "Jewelry and Watches",
    price: 200,
    description: "A large case, available in a host of colors with gloss finishes and a 7-year battery make for stylish and reliable timepiece." +
                " Gloss white resin band digital watch with white face.",
    popular: false,
    imageUrls: [
  ...
  {
    id: 7,
    name: "Watch -Black Men's Pro Diver Collection ",
    category: "Jewelry and Watches",
    price: 130,
    description:
